function closeshort(obj,time,price,quantity,i)
...
if obj.GetPosition()<0
    ...
    elseif abs(obj.CurrentStatus.GetPosition())<quantity&&obj.CurrentStatus.GetPosition()<=0
        realQuantity=abs(obj.CurrentStatus.GetPosition());
    end
    ...
    %Refresh position
    obj.CurrentStatus.closeshort(time,price,realQuantity);
end
