...
function TranslateTick2Bar(SDate,EDate,Interval,varargin)
%设置默认参数
p                   = inputParser;
...
ThisTargetFolder=['F:\Cache\Data\',datestr(Interval),'Min\Bar'];
ThisDataSource  ='F:\期货分笔数据mat';
...
sm.ReadProduct_Divided('Tick','Bar','mat','MAT',Interval,'SearchMode',p.Results.SearchMode,'Overwrite',p.Results.Overwrite);
toc
% 
