...
matlab -nosplash -nodesktop -minimize -r "S_UpdateLocalData('DataProvider','Bloomberg','InputType','Bar','OutputType','Bar','InputFileType','csv','OutputFileType','csv','TransformData',false,'ByDay',true,'Overwrite',false,'isNight',true);exit"
ECHO **************************************************
ECHO MATLAB自动运行结束
