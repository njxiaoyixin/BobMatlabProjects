...
function TranslateBar2Daily(SDate,EDate,Interval,varargin)
%设置默认参数
p                   = inputParser;
...
ThisTargetFolder='F:\Cache\Data\Daily\Bar';
ThisDataSource  ='F:\Cache\Data\1Min\Bar';
sm         = WindPackage.DailyData;
...
sm.ReadProduct_Divided('Bar','Day','mat','MAT',Interval,'SearchMode',p.Results.SearchMode,'Overwrite',p.Results.Overwrite);
toc
% 
